...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('admin_backend_assets') }}/css/perfect-scrollbar.min.css" />
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('admin_backend_assets') }}/css/style.css" />
        <link defer rel="stylesheet" type="text/css" media="screen" href="{{ asset('admin_backend_assets') }}/css/animate.css" />
                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="{{ asset('admin_backend_assets') }}/images/logo.svg" alt="image" />
                    ...
                    <div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="index.html" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('admin_backend_assets') }}/images/logo.svg" alt="image" />
                                    <span
