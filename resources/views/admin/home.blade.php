...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('admin_backend_assets') }}/css/perfect-scrollbar.min.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('admin_backend_assets') }}/css/style.css" />
    <link defer rel="stylesheet" type="text/css" media="screen"
        href="{{ asset('admin_backend_assets') }}/css/animate.css" />
    <script src="{{ asset('admin_backend_assets') }}/js/perfect-scrollbar.min.js"></script>
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
        ...
        <div :class="{ 'dark text-white-dark': $store.app.semidark }">
            <nav x-data="sidebar"
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="index.html" class="main-logo flex shrink-0 items-center">
                            <img class="ml-[5px] w-8 flex-none"
                                src="{{ asset('admin_backend_assets') }}/images/logo.svg" alt="image" />
                            <span
                    ...
                    <ul class="perfect-scrollbar relative  space-y-0.5 overflow-y-hidden overflow-x-hidden p-4 py-0 font-semibold"
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="10"
                    ...
                    <ul class="perfect-scrollbar relative  space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22ZM8.39747 15.5534C8.64413 15.2206 9.11385 15.1508 9.44661 15.3975C10.175 15.9373 11.0541 16.25 12 16.25C12.9459 16.25 13.825 15.9373 14.5534 15.3975C14.8862 15.1508 15.3559 15.2206 15.6025 15.5534C15.8492 15.8862 15.7794 16.3559 15.4466 16.6025C14.4742 17.3233 13.285 17.75 12 17.75C10.715 17.75 9.5258 17.3233 8.55339 16.6025C8.22062 16.3559 8.15082 15.8862 8.39747 15.5534ZM16 10.5C16 11.3284 15.5523 12 15 12C14.4477 12 14 11.3284 14 10.5C14 9.67157 14.4477 9 15 9C15.5523 9 16 9.67157 16 10.5ZM9 12C9.55228 12 10 11.3284 10 10.5C10 9.67157 9.55228 9 9 9C8.44772 9 8 9.67157 8 10.5C8 11.3284 8.44772 12 9 12Z" fill="currentColor"></path>
                                    </svg>

                                    <span
                                        class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark"> Web Profile   </span>
                                </div>
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'dashboard' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="{{ route('admin.webview_profile.create') }}" class="active"> Create Profile </a>
                                </li>
                                <li>
                                    <a href="analytics.html">Analytics</a>
                                </li>
        ...
        <div class="main-content flex min-h-screen flex-col">
                ...
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                        ...
                        <div x-data="header"
                            ...
                            <div class="mr-5">
                                <a href="{{ route('index') }}" target="_blank" type="button"
                                    class="btn btn-success">Visti Website</a>
                            </div>
                            {{-- Frontnd Viewer Button --}}
                                    ...
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            ...
                                            <div class="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 class="text-base">
                                                    {{ Auth::user()->name }}<span
                                                        class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">{{ Auth::user()->usertype }}</span>
                                                </h4>
                        ...
                        <li class="menu nav-item relative">
                            <a href="javascript:;" class="nav-link active">
                                <div class="flex items-center">
                                    ...
                                    <a href="" class="px-1"> Web Profile </a>
                                </div>
                                <div class="right_arrow">
                                    <svg class="h-4 w-4 rotate-90" width="16" height="16" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-auto p-6 pt-0 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                © <span id="footer-year"> {{ date('Y') }} </span>. Fahim Uddin Raafi | All rights reserved.
            </div>
            <!-- end footer section -->
        </div>
    </div>

    <script src="{{ asset('admin_backend_assets') }}/js/alpine-collaspe.min.js"></script>
    <script src="{{ asset('admin_backend_assets') }}/js/alpine-persist.min.js"></script>
    <script defer src="{{ asset('admin_backend_assets') }}/js/alpine-ui.min.js"></script>
    <script defer src="{{ asset('admin_backend_assets') }}/js/alpine-focus.min.js"></script>
    <script defer src="{{ asset('admin_backend_assets') }}/js/alpine.min.js"></script>
    <script src="{{ asset('admin_backend_assets') }}/js/custom.js"></script>
    <script defer src="{{ asset('admin_backend_assets') }}/js/apexcharts.js"></script>
