...
@section('content')
    <div class="main-wrapper">
        <div class="container-fluid container-fluid grid grid-cols-1 gap-4 mx-8">
            ...
            <div class="mx-auto">
                <div class="panel lg:col-start-2 lg:row-start-3">
                    ...
                    <div class="mb-5">
                        <form class="space-y-5" action="{{ route('admin.frontend_profile.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <input id="" type="file" placeholder="" class="form-input" name="logo">
                            </div>
